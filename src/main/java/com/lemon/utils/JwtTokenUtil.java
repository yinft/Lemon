...
public class JwtTokenUtil implements Serializable {
    ...
    public  String getUserName(HttpServletRequest request){
        ...
        if(StringUtils.isEmpty(authToken)||authToken.length()<7){
            throw new BaseException(ResultEnum.FORBIDDEN.getCode(),ResultEnum.FORBIDDEN.getMessage());
        }
        ...
        try {
            ...
            throw new BaseException(ResultEnum.UNAUTHORIZED.getCode(),ResultEnum.UNAUTHORIZED.getMessage());
        }
